      ...
      <>
        ...
        <div className="p-4">
          <div className="flex items-center space-x-2 mb-3">
            <img className="rounded-full bg-gray-300 h-8 w-8" src={apple1} alt="N" />
    ...
    {tab === "Create Post" && (
      <>
        <div className="flex items-center px-4 py-3 space-x-3">
          <img
            src={apple1} // Replace with actual profile image
            alt="Profile"
            className="rounded-full w-10 h-10"
          />
          <div>
            <h4 className="font-semibold text-gray-800">Shakir Umar</h4>
            <select className="text-sm border rounded-full px-2 py-1 hover:bg-gray-100">
              <option value="Jobner">Everyone</option>
